  ...
  const fetchFacebookData = async () => {
    ...
    try {
      ...
      for (let i = 0; i < activePages.length; i++) {
        ...
        // Fetch total revenue (includes ads, stars, subscriptions - excludes bonuses)
        const approxEarningsData = await fetchPageInsights(
          pageId, pageToken, 'monetization_approximate_earnings',
          dateRange.since, dateRange.until
        );

        // Fallback to content_monetization_earnings if approx doesn't work
        const contentEarningsData = approxEarningsData ? null : await fetchPageInsights(
        ...
        const revenue = sumDailyValues(approxEarningsData || contentEarningsData, true);
